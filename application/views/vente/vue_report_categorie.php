            ...
            <section class="wrapper main-wrapper" style=''>
                ...
                <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                    <div class="page-title">
                        ...
                        <div class="pull-left" style="width: 100%;">
                            <h1 class="title">Sales Report By Category 
                                <span class="pull-right"> <a href="<?php echo site_url('Vente/report'); ?>" class="btn btn-purple">All report 
                            </a>&nbsp;&nbsp;<a href="<?php echo site_url('Vente/reportProduct'); ?>" class="btn btn-purple">Product report </a></span></h1>
                        </div>
                ...
                <div class="col-lg-12">
                        <section class="box ">
                            ...
                            <form method="post" action="<?php echo base_url('Vente/reportCategorie');?>">
                                <div class='row'>
                                        <div class="col-xs-3">
